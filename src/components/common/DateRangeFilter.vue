  ...
  <div class="p-4 bg-white dark:bg-gray-800 shadow-md rounded-lg mb-6">
    <div class="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4 mb-4">
      <div class="flex-1 w-full">
        <label for="start-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">開始日期</label>
        <input
          id="start-date"
          type="date"
      ...
      <div class="flex-1 w-full">
        <label for="end-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">結束日期</label>
        <input
          id="end-date"
          type="date"
          :value="modelEndDate"
    ...
    <div v-if="isFilterActive" class="mt-4 text-sm text-gray-600 dark:text-gray-400">
