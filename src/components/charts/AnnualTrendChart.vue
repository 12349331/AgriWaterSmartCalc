...
import { LineChart, BarChart } from 'echarts/charts'  // User Story 004: Added BarChart
import {
  TitleComponent,
  TooltipComponent,
  GridComponent,
...
use([
  CanvasRenderer,
  LineChart,
  BarChart,  // User Story 004: Added BarChart
  TitleComponent,
  TooltipComponent,
  GridComponent,
  LegendComponent,
...
const chartOption = computed(() => ({
  ...
  series: [
    ...
    {
      name: '用電度數',
      type: 'bar',  // User Story 004: Changed from "line" to "bar"
      yAxisIndex: 1,
      data: chartData.value.kwhs,
      itemStyle: {
        color: '#10b981',  // Maintained green color
      },
    },
  ],
}))
